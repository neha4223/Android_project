package com.example.neha.wikipedia;
...
import static com.example.neha.wikipedia.R.id.etxSearch;
import static com.example.neha.wikipedia.R.id.txtWikiData;
...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        editText = (EditText) findViewById(etxSearch);
        btnfetchdata = (Button) findViewById(R.id.btnFetchData);
        textView = (TextView) findViewById(txtWikiData);
